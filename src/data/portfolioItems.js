const portfolioItems = [
		...
		items: [
			{
				...
				description:
					'A PWA that teaches children to read and spell. Built with Next.js, Postgres, and PHP.',
			},
		],
	},
	{
	...
	},
	{
		...
		items: [
			{
				title: 'Magia Arcanum',
				route: 'https://youtu.be/EAqZN6A3oCs',
				description:
					'A retro RPG game written in JavaScipt. AI-powered dialog. Voices generated by Eleven Labs.',
			},
			{
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				description:
					'Completely custom-built SSG in PHP. All vanilla JS and static HTML pages. Blazingly fast!',
			},
			{
