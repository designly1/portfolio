        ...
        <>
            ...
            <div className="bg-bg1 h-screen flex flex-col text-white">
                <div className="m-auto flex flex-col">
                    <h1 className="text-6xl text-center mb-4">Error <span className="text-gray-400">500</span></h1>
                    <p className="text-center">An internal server error has occurred. Sorry.</p>
